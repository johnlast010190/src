...
Description
    ...
    - extrude edges inbetween different faceZones as a
      (nonuniformTransform)cyclic \<zoneA\>_\<zoneB\> (no longer supported)
...
int main(int argc, char *argv[])
{
    ...
    // Commented due to the use of a now unsupported patch
    // (nonuniformTransformCyclicPolyPatch).
    // May lead to errors on film flows simulations
    /* addInterZonePatches
    (
        mesh,
        zoneNames,
