...
)
{
    ...
    auto ctor = ctorTableLookup("temperaturePhaseChangeTwoPhaseMixture type", componentsConstructorTable_(), temperaturePhaseChangeTwoPhaseMixtureTypeName);
    return autoPtr<temperaturePhaseChangeTwoPhaseMixture>(ctor(thermo, mesh));
}
