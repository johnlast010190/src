...
int Foam::IOdictionary::globalIOdictionary
(
    Foam::debug::infoSwitch("globalIOdictionary", 1)
);
...
void Foam::IOdictionary::operator=(const baseIOdictionary& rhs)
{
    baseIOdictionary::operator=(rhs);
}


void Foam::IOdictionary::operator=(const dictionary& rhs)
{
