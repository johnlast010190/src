...
)
{
    ...
    )
    {
        ...
        const auto ctor = ctorTableLookup("GAMGProcAgglomeration type", lduMeshConstructorTable_(), agglomeratorType);
...
)
{
    ...
    const auto ctor = ctorTableLookup("GAMGAgglomeration type", geometryConstructorTable_(), agglomeratorType);
