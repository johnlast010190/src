...
namespace Foam
{
    ...
    defineRunTimeSelectionTable(psiChemistryModel, objectRegistry);
}
...
:
    ...
    thermo_(psiReactionThermo::New(obr, phaseName))
{}
...
{
    return basicChemistryModel::New<psiChemistryModel>(obr, phaseName);
}
