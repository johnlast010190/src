...
#include "matHeRhoThermo.H"

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

template<class BasicRhoThermo, class MixtureType>
void Foam::matHeRhoThermo<BasicRhoThermo, MixtureType>::calculate
(
...
)
{
    ...
    if (doOldTimes && (p.nOldTimes() || T.nOldTimes()))
    {
        ...
        this->materials_.updateScalarField
        (
            this->phasePropertyName("T"),
            T.oldTime()
        );
        this->materials_.updateScalarField
        (
            this->phasePropertyName(he.name()),
            he.oldTime()
        );
        calculate
        (
...
template<class BasicRhoThermo, class MixtureType>
Foam::matHeRhoThermo<BasicRhoThermo, MixtureType>::matHeRhoThermo
(
    const objectRegistry& obr,
    const word& phaseName
)
:
    matHeThermo<BasicRhoThermo, MixtureType>(obr, phaseName),
    obr_(obr)
{
    calculate
    (
...
template<class BasicRhoThermo, class MixtureType>
void Foam::matHeRhoThermo<BasicRhoThermo, MixtureType>::correct()
{
    calculate
    (
        this->p_,
