...
namespace Foam
{
    ...
    defineRunTimeSelectionTable(solidReactionThermo, objectRegistry);
...
:
    solidThermo(obr, dict, phaseName)
{}
...
{
    return basicThermo::New<solidReactionThermo>(obr, phaseName);
}
...
{
    return basicThermo::New<solidReactionThermo>(obr, dict, phaseName);
}
