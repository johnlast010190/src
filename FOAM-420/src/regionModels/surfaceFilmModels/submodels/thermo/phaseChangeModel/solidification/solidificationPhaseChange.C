...
#include "submodels/thermo/phaseChangeModel/solidification/solidificationPhaseChange.H"
...
defineTypeNameAndDebug(solidificationPhaseChange, 0);

addToRunTimeSelectionTable
(
    phaseChangeModel,
    solidificationPhaseChange,
    dictionary
);

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

solidificationPhaseChange::solidificationPhaseChange
(
...
void solidificationPhaseChange::correctModel
(
    const scalar dt,
