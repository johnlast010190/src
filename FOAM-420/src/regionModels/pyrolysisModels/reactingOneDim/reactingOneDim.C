...
void reactingOneDim::updateqr()
{
    ...
    qr_.forceAssign(dimensionedScalar("zero", qr_.dimensions(), 0.0));
...
{
    phiHsGas_.forceAssign(dimensionedScalar("zero", phiHsGas_.dimensions(), 0.0));
    phiGas_.forceAssign(dimensionedScalar("zero", phiGas_.dimensions(), 0.0));
