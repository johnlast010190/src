...
)
{
    ...
    reorderPatchFields<volVector1Field>(mesh, oldToNew);
    reorderPatchFields<volVector4Field>(mesh, oldToNew);
    reorderPatchFields<volTensor4Field>(mesh, oldToNew);
...
void Foam::fvMeshTools::trimPatches(fvMesh& mesh, const label nPatches)
{
    ...
    trimPatchFields<volVector1Field>(mesh, nPatches);
    trimPatchFields<volVector4Field>(mesh, nPatches);
    trimPatchFields<volTensor4Field>(mesh, nPatches);
}
