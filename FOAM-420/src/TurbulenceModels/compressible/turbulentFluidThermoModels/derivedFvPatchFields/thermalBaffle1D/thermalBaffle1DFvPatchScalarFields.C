...
#include "turbulentFluidThermoModels/derivedFvPatchFields/thermalBaffle1D/thermalBaffle1DFvPatchScalarFields.H"
...
namespace compressible
{
    ...
    (
        ...
        thermalBaffle1D_hConstSolidThermoPhysics
    );
    ...
    (
        fvPatchScalarField,
        expoSolid_thermalBaffle1DFvPatchScalarField,
        thermalBaffle1D<hPowerSolidThermoPhysics>,
        thermalBaffle1D_hPowerSolidThermoPhysics
    );
