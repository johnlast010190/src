...
Foam::porousBafflePressureFvPatchField::computeUn() const
{
    ...
    // The conversion to [m/s] has to be done
    // before any other components of velocity are added
    // Otherwise for example with pure MRF the actual velocity gets devided
    // by density.
