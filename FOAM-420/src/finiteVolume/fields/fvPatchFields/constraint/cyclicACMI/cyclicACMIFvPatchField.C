...
Foam::cyclicACMIFvPatchField<Type>::nbrPatchField() const
{
    ...
    (
        fld.boundaryField()[cyclicACMIPatch_.nbrPatchID()]
    );
}
...
) const
{
    ...
    const labelUList& nbrFaceCellsCoupled = cpp.nbrPatch().faceCells();
