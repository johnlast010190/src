        ...
        forAllIter(HashTable<surfaceVectorField*>, Ufs, iter)
        {
            ...
            if (!isNull(U))
            {
                forAll(Uf.boundaryField(), patchi)
                {
                    ...
                    {
                        Uf.boundaryFieldRef()[patchi].forceAssign
                        (
...
) const
{
    ...
    nccFieldb.forceAssign(pTraits<Type>::zero);
    ...
    forAll(origPatchIDs, i)
    {
        ...
        if (isFluxField)
        {
            ...
            nccFieldb[origPatchi] *=
                origSumMagSf
               /max(origNccMagSfb[origPatchi], patchToPatch::small*origSumMagSf);
        }
        ...
        {
            nccFieldb[origPatchi] /=
                max(origNccMagSfb[origPatchi], patchToPatch::vSmall);
        }
    }
    ...
    if (isFluxField)
    {
        ...
        forAll(origPatchIDs, i)
        {
            ...
            origFieldb[origPatchi] *=
                origSumMagSf
               /max(magSfb[origPatchi], patchToPatch::small*origSumMagSf);
        }
    }
