...
Foam::scalar Foam::hConst::CpCell(const label celli) const
{
...
Foam::tmp<Foam::scalarField> Foam::hConst::CpPatch
(
    const label patchi
) const
{
...
Foam::tmp<Foam::scalarField> Foam::hConst::CpInternal() const
{
    if (sMod_(CpDeparture) == nullptr)
    {
...
Foam::tmp<Foam::volScalarField> Foam::hConst::CpGeometric() const
{
    if (sMod_(CpDeparture) == nullptr)
    {
...
Foam::scalar Foam::hConst::HaCell(const label celli) const
{
...
Foam::tmp<Foam::scalarField> Foam::hConst::HaPatch
(
    const label patchi
) const
{
...
Foam::tmp<Foam::scalarField> Foam::hConst::HaInternal() const
{
    if (sMod_(HDeparture) == nullptr)
    {
...
Foam::tmp<Foam::volScalarField> Foam::hConst::HaGeometric() const
{
    if (sMod_(HDeparture) == nullptr)
    {
...
Foam::scalar Foam::hConst::HsCell(const label celli) const
{
    if (sMod_(HDeparture) == nullptr)
    {
...
Foam::tmp<Foam::scalarField> Foam::hConst::HsPatch
(
    const label patchi
) const
{
...
Foam::tmp<Foam::scalarField> Foam::hConst::HsInternal() const
{
    if (sMod_(HDeparture) == nullptr)
    {
...
Foam::tmp<Foam::volScalarField> Foam::hConst::HsGeometric() const
{
    if (sMod_(HDeparture) == nullptr)
    {
...
Foam::scalar Foam::hConst::SCell(const label celli) const
{
...
Foam::tmp<Foam::scalarField> Foam::hConst::SPatch
(
    const label patchi
) const
{
...
Foam::tmp<Foam::scalarField> Foam::hConst::SInternal() const
{
    if (sMod_(SDeparture) == nullptr)
    {
...
Foam::tmp<Foam::volScalarField> Foam::hConst::SGeometric() const
{
    if (sMod_(SDeparture) == nullptr)
    {
        return SThermoGeometric();
    }
    return sMod_[SDeparture]() + SThermoGeometric();
}
