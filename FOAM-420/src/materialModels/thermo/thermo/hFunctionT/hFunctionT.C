...
void Foam::hFunctionT::updateTable(const word& modelName)
{
    ...
    else if (modelName == HsName)
    {
        ...
        if (models.found(HDepartureName))
        {
            ...
            dep_[2].dependencies.set(0, models[HaName]);
            dep_[2].dependencies.set(1, models[HcName]);
            dep_[2].dependencies.set(2, models[HDepartureName]);
        }
    }
...
Foam::scalar Foam::hFunctionT::CpCell(const label celli) const
{
...
Foam::tmp<Foam::scalarField> Foam::hFunctionT::CpPatch
(
    const label patchi
) const
{
...
Foam::tmp<Foam::scalarField> Foam::hFunctionT::CpInternal() const
{
    if (sMod_(CpDeparture) == nullptr)
    {
...
Foam::tmp<Foam::volScalarField> Foam::hFunctionT::CpGeometric() const
{
    if (sMod_(CpDeparture) == nullptr)
    {
...
Foam::scalar Foam::hFunctionT::HaCell(const label celli) const
{
...
Foam::tmp<Foam::scalarField> Foam::hFunctionT::HaPatch
(
    const label patchi
) const
{
...
Foam::tmp<Foam::scalarField> Foam::hFunctionT::HaInternal() const
{
    if (sMod_(HDeparture) == nullptr)
    {
...
Foam::tmp<Foam::volScalarField> Foam::hFunctionT::HaGeometric() const
{
    if (sMod_(HDeparture) == nullptr)
    {
...
Foam::scalar Foam::hFunctionT::HsCell(const label celli) const
{
    if (sMod_(HDeparture) == nullptr)
    {
        return sMod_[Ha][celli] - sMod_[HcInd][celli];
    }
    return
        sMod_[HDeparture][celli] + sMod_[Ha][celli] - sMod_[HcInd][celli];
}


Foam::tmp<Foam::scalarField> Foam::hFunctionT::HsPatch
(
    const label patchi
) const
{
    if (sMod_(HDeparture) == nullptr)
    {
        return sMod_[Ha].boundaryField()[patchi] - sMod_[HcInd].boundaryField()[patchi];
    }
    return
        sMod_[HDeparture].boundaryField()[patchi]
...
Foam::tmp<Foam::scalarField> Foam::hFunctionT::HsInternal() const
{
    if (sMod_(HDeparture) == nullptr)
    {
        return sMod_[Ha].primitiveField() - sMod_[HcInd].primitiveField();
    }
    return
        sMod_[HDeparture].primitiveField()
...
Foam::tmp<Foam::volScalarField> Foam::hFunctionT::HsGeometric() const
{
    if (sMod_(HDeparture) == nullptr)
    {
        return sMod_[Ha]() - sMod_[HcInd]();
    }
    return
        sMod_[HDeparture]()
      + sMod_[Ha]()
...
Foam::scalar Foam::hFunctionT::SCell(const label celli) const
{
...
Foam::tmp<Foam::scalarField> Foam::hFunctionT::SPatch
(
    const label patchi
) const
{
...
Foam::tmp<Foam::scalarField> Foam::hFunctionT::SInternal() const
{
    if (sMod_(SDeparture) == nullptr)
    {
...
Foam::tmp<Foam::volScalarField> Foam::hFunctionT::SGeometric() const
{
    if (sMod_(SDeparture) == nullptr)
    {
