...
{
    return autoPtr<solidPolynomial>
    (
        new solidPolynomial(*this)
    );
}
...
Foam::vector Foam::solidPolynomial::vKappaCell(const label celli) const
{
...
Foam::tmp<Foam::vectorField> Foam::solidPolynomial::vKappaPatch
(
    const label patchi
) const
{
...
Foam::tmp<Foam::vectorField> Foam::solidPolynomial::vKappaInternal() const
{
    tmp<vectorField> tvKappa
    (
...
Foam::solidPolynomial::vKappaGeometric() const
{
