...
{
    const auto ctor = ctorTableLookup("set type", wordConstructorTable_(), setType);
...
{
    const auto ctor = ctorTableLookup("set type", sizeConstructorTable_(), setType);
...
{
    const auto ctor = ctorTableLookup("set type", setConstructorTable_(), setType);
