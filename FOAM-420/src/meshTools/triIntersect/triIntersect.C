...
)
{
    ...
    if (!noIntersection)
    {
        ...
        // One target point is a source point and the other is outside
        // a source edge
        ...
        // One target point is outside a source edge and the other is outside
        // a source corner
        ...
        forAll(tgtPs, tgtEi)
        {
            ...
            (
                tgtInSrcTri0 && (tgtOutSrcEi1 != -1 || tgtOutSrcPi1 != -1)
            )
            {
            ...
            (
                (tgtOutSrcEi0 != -1 || tgtOutSrcPi0 != -1) && tgtInSrcTri1
            )
            {
