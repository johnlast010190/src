...
Foam::tmp<Foam::volScalarField> Foam::incompressibleTwoPhaseMixture::Cp() const
{
    NotImplemented;
}

Foam::tmp<Foam::volScalarField> Foam::incompressibleTwoPhaseMixture::lambda() const
{
    NotImplemented;
}
...
Foam::tmp<Foam::volScalarField> Foam::incompressibleTwoPhaseMixture::alphaLam() const
{
    NotImplemented;
}
